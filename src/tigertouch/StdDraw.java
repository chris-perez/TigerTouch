package tigertouch; /*************************************************************************
 *  Compilation:  javac tigertouch.StdDraw.java
 *  Execution:    java tigertouch.StdDraw
 *
...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    *************************************************************************/
    ...
    /*	if(e.getButton() == MouseEvent.BUTTON1){
    		leftClicked = true;
			System.out.println("Button 1 Clicked: " + mouseX() + ", " + mouseY());
			
    	}
    	if(e.getButton() == MouseEvent.BUTTON3){
    		rightClicked = true;
			System.out.println("Button 2 Clicked: " + mouseX() + ", " + mouseY());
